    ...
    <span className="font-bold text-2xl text-[hsl(222,47%,11%)]">Agadh</span>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl shadow-md border border-[hsl(214,32%,91%)] p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="phone" className="text-sm font-medium text-[hsl(222,47%,11%)] mb-2 block">
                  Mobile Number
                </label>
                <div className="flex">
      ...
      <footer className="py-6 text-center">
        <p className="text-xs text-[hsl(215,16%,47%)]">
          ...
          <Link href="/Privacy" className="text-[hsl(221,83%,53%)] hover:underline">
            Privacy Policy
          </Link>{" "}
          and{" "}
          <Link href="/Terms" className="text-[hsl(221,83%,53%)] hover:underline">
            Terms of Service
          </Link>
        </p>
      </footer>
